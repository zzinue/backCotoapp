...
const get = async () => {
    ...
    return await Gastos_configuracion.find().populate("gastos_configuracion").exec();

}

const getById = async (id) => {
    const gastos_configuracion =  await Gastos_configuracion.findById(id).populate("gastos_configuracion").exec();
...
const update = async (id, Gastos_configuracionData) => {
    ...
    const { 
        concepto,monto,descripcion,imagen,seRepite,periodicidad } = Gastos_configuracionData;
