...
const get = async () => {
    ...
    return await Gasto.find().populate("gasto").exec();

}

const getById = async (id) => {
    const gasto =  await Gasto.findById(id).populate("gasto").exec();
    return gasto;
    //devuelve un gasto
}
